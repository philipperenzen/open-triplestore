...
use super::models::{SubGraphStatus, VersionStatus, VocabularyRecord, VocabularyVersion};
...
pub fn update_version_notes(
    ...
    let ver_iri = format!(
        "{}/vocabulary/{}/version/{}",
        base_url, vocabulary_id, version
    );
