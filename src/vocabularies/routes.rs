...
pub fn vocabulary_auth_routes() -> Router<AppState> {
    Router::new()
        .route("/api/vocabularies", post(handlers::create_vocabulary))
        .route(
            "/api/vocabularies/:id",
        ...
        .route("/api/vocabularies/:id/merge", post(handlers::merge_apply))
        .route(
