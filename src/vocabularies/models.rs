//! vocabulary versioning system.

use serde::{Deserialize, Serialize};

/// Status of a vocabulary version.
...
/// Summary of a vocabulary (for list views).
...
/// Metadata for a single vocabulary version.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct VocabularyVersion {
    ...
    /// Per-subgraph lifecycle overrides (Phase 6 — per-subgraph publishing).
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct VocabularyVersionWithDetection {
    pub version: VocabularyVersion,
...
/// Body for `POST /api/vocabularies/:id/branches`.
#[derive(Debug, Deserialize)]
pub struct CreateBranchRequest {
    pub branch: String,
    /// The version to fork from (can be a branch tip version).
...
/// Body for `POST /api/vocabularies/:id/versions/:ver/rebase`.
#[derive(Debug, Deserialize)]
...
/// (`POST /api/vocabularies/:id/versions/:ver/subgraph/{stage,publish,deprecate}`).
#[derive(Debug, Deserialize)]
