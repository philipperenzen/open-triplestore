...
pub fn saved_query_public_routes() -> Router<AppState> {
    Router::new()
        ...
        .route(
            "/api/datasets/:dataset_id/api-services/:slug/revisions",
            get(dataset::revisions),
        )
        .route(
            "/api/datasets/:dataset_id/api-services/:slug/tests",
            get(dataset::tests),
        )
        .route(
        ...
        .route(
            "/api/datasets/:dataset_id/openapi.json",
            get(dataset::openapi),
        )
        // ── Organisation scope ──
        ...
        .route(
            "/api/organisations/:org_id/api-services/:slug/revisions",
            get(org::revisions),
        )
        .route(
            "/api/organisations/:org_id/api-services/:slug/tests",
            get(org::tests),
        )
        .route(
        ...
        .route(
            "/api/groups/:group_id/api-services/:slug/revisions",
            get(group::revisions),
        )
        .route(
            "/api/groups/:group_id/api-services/:slug/tests",
            get(group::tests),
        )
        .route(
...
pub fn saved_query_auth_routes() -> Router<AppState> {
    Router::new()
        // ── Dataset scope ──
        .route(
            "/api/datasets/:dataset_id/api-services",
            post(dataset::create),
        )
        .route(
            "/api/datasets/:dataset_id/api-services/:slug",
        ...
        .route(
            "/api/datasets/:dataset_id/api-services/:slug/repair",
            post(dataset::repair),
        )
        .route(
        ...
        .route(
            "/api/organisations/:org_id/api-services/:slug/repair",
            post(org::repair),
        )
        .route(
        ...
        .route(
            "/api/groups/:group_id/api-services/:slug/repair",
            post(group::repair),
        )
        .route(
