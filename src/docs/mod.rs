...
const COLS: &str =
    "slug, title, category, body_md, admin_only, source, sort_order, updated_by, updated_at";
...
impl DocStore {
    ...
    pub fn get(&self, slug: &str, include_admin: bool) -> anyhow::Result<Option<Doc>> {
        ...
        let doc = conn
            .query_row(
                &format!("SELECT {COLS} FROM docs WHERE slug = ?1"),
                params![slug],
                |r| read_doc(r, true),
            )
            .optional()?;
...
const BUILTINS: &[Builtin] = &[
    ...
    Builtin {
        ...
        title: "Named Graphs",
        category: "Concepts",
        body: include_str!("../../docs/named-graphs.md"),
        admin_only: false,
        sort: 10,
    },
    Builtin {
        ...
        title: "Datasets",
        category: "Concepts",
        body: include_str!("../../docs/datasets.md"),
        admin_only: false,
        sort: 12,
    },
    Builtin {
        ...
        title: "Organisations",
        category: "Concepts",
        body: include_str!("../../docs/organisations.md"),
        admin_only: false,
        sort: 14,
    },
    Builtin {
        ...
        category: "Concepts",
        body: include_str!("../../docs/versioning.md"),
        admin_only: false,
        sort: 16,
    },
    // ── Modelling ──
    Builtin {
        ...
        category: "Modelling",
        body: include_str!("../../docs/modelling.md"),
        admin_only: false,
        sort: 30,
    },
    Builtin {
        ...
        category: "Modelling",
        body: include_str!("../../docs/data-modeling.md"),
        admin_only: false,
        sort: 32,
    },
    Builtin {
        slug: "linked-data-modelling-styleguide",
        title: "Modelling Styleguide",
        category: "Modelling",
        body: include_str!("../../docs/linked-data-modelling-styleguide.md"),
        admin_only: false,
        sort: 34,
    },
    Builtin {
        slug: "models",
        title: "Model & Vocabulary Versioning",
        category: "Modelling",
        body: include_str!("../../docs/models.md"),
        admin_only: false,
        sort: 36,
    },
    Builtin {
        slug: "dcat",
        title: "DCAT Catalogue",
        category: "Modelling",
        body: include_str!("../../docs/dcat.md"),
        admin_only: false,
        sort: 38,
    },
    // ── Data Exchange ──
    Builtin {
        ...
        body: include_str!("../../docs/formats.md"),
        admin_only: false,
        sort: 50,
    },
    Builtin {
        slug: "import",
        title: "Import Auto-Detection",
        category: "Data Exchange",
        body: include_str!("../../docs/import.md"),
        admin_only: false,
        sort: 52,
    },
    // ── Query & Search ──
    Builtin {
        slug: "search-syntax",
        title: "Browse & Search Syntax",
        category: "Query & Search",
        body: include_str!("../../docs/search-syntax.md"),
        admin_only: false,
        sort: 60,
    },
    Builtin {
        ...
        category: "Query & Search",
        body: include_str!("../../docs/full-text-search.md"),
        admin_only: false,
        sort: 62,
    },
    Builtin {
        ...
        title: "GeoSPARQL",
        category: "Query & Search",
        body: include_str!("../../docs/geosparql.md"),
        admin_only: false,
        sort: 64,
    },
    Builtin {
    ...
    Builtin {
        ...
        body: include_str!("../../docs/reasoning.md"),
        admin_only: false,
        sort: 80,
    },
    Builtin {
        ...
        category: "Reasoning & Validation",
        body: include_str!("../../docs/shacl.md"),
        admin_only: false,
        sort: 82,
    },
    // ── Security ──
    Builtin {
        slug: "auth",
        title: "Authentication & API Tokens",
        category: "Security",
        body: include_str!("../../docs/auth.md"),
        admin_only: false,
        sort: 100,
    },
    Builtin {
    ...
    Builtin {
        slug: "api-services",
        title: "API Services & AI Queries",
        category: "API & Operations",
        body: include_str!("../../docs/api-services.md"),
        admin_only: false,
        sort: 110,
    },
    Builtin {
    ...
    Builtin {
        ...
        title: "Operations",
        category: "API & Operations",
        body: include_str!("../../docs/operations.md"),
        admin_only: false,
        sort: 114,
    },
    // ── Reference ──
    Builtin {
        ...
        category: "Reference",
        body: include_str!("../../docs/standards.md"),
        admin_only: false,
        sort: 130,
    },
    Builtin {
        ...
        title: "Datatypes",
        category: "Reference",
        body: include_str!("../../docs/datatypes.md"),
        admin_only: false,
        sort: 132,
    },
    Builtin {
    ...
    Builtin {
        ...
        title: "Dataset Governance & SHACL Model (Admin)",
        category: "Administration",
        body: DATASET_GOVERNANCE_MD,
        admin_only: true,
        sort: 200,
    },
];
...
pub async fn create_doc(
    ...
    let saved = store
        .get(&doc.slug, true)
        .map_err(e500)?
        .ok_or_else(|| e500("doc vanished after upsert"))?;
    Ok(Json(saved))
}
...
pub fn routes() -> Router<AppState> {
    Router::new().route("/api/docs", get(list_docs)).route(
        "/api/docs/:slug",
        get(get_doc)
            .put(create_doc)
            .post(create_doc)
