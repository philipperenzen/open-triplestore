...
pub fn data_model_public_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/api/data-models/:id/versions", get(handlers::list_versions))
        .route(
        ...
        .route("/api/data-models/:id/collaborators", get(handlers::list_collaborators))
        .route("/api/data-models/:id/commits", get(handlers::list_commits))
        .route("/api/data-models/:id/branches", get(handlers::list_branches).post(handlers::create_branch))
        .route("/api/data-models/:id/merge/preview", get(handlers::merge_preview))
        .route("/api/data-models/:id/term", get(super::deref::describe_term))
}
...
pub fn data_model_auth_routes() -> Router<AppState> {
    Router::new()
        .route(
            "/api/data-models",
            post(handlers::create_data_model),
        )
        .route(
            "/api/data-models/:id",
