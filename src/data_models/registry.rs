...
pub fn get_data_model(store: &TripleStore, base_url: &str, data_model_id: &str) -> Option<DataModelRecord> {
...
pub fn update_version_notes(
    ...
    let ver_iri = format!("{}/data-model/{}/version/{}", base_url, data_model_id, version);
...
pub fn list_versions(store: &TripleStore, base_url: &str, data_model_id: &str) -> Vec<DataModelVersion> {
    let ont_iri = format!("{}/data-model/{}", base_url, data_model_id);
    let q = format!(
        r#"
        PREFIX ver: <{VER}>
