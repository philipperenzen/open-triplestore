...
export const VOCAB_FILES: Record<string, VocabFileSpec> = {
  ...
  'https://example.org/vocab/def/': { file: 'otl.ttl', source: 'otl' },
  // Legacy demo excerpt (def/) vs the full IMBOR 2025 Vocabulaire (term/).
  'https://data.crow.nl/imbor/def/': { file: 'imbor-def.ttl', source: 'imbor' },
  'https://data.crow.nl/imbor/term/': { file: 'imbor.ttl', source: 'imbor' },
  ...
  // LOV expansion pack (full vocabularies from the bundled LOV corpus).
  'http://purl.org/vocommons/voaf#': { file: 'voaf.ttl', source: 'voaf' },
  'http://www.w3.org/ns/adms#': { file: 'adms.ttl', source: 'adms' },
  'http://www.w3.org/2006/vcard/ns#': { file: 'vcard.ttl', source: 'vcard' },
  'http://rdfs.org/sioc/ns#': { file: 'sioc.ttl', source: 'sioc' },
  'http://purl.org/ontology/bibo/': { file: 'bibo.ttl', source: 'bibo' },
  'http://www.w3.org/ns/oa#': { file: 'oa.ttl', source: 'oa' },
  'http://www.w3.org/ns/odrl/2/': { file: 'odrl.ttl', source: 'odrl' },
  'http://creativecommons.org/ns#': { file: 'cc.ttl', source: 'cc' },
  'http://www.w3.org/2003/06/sw-vocab-status/ns#': { file: 'vs.ttl', source: 'vs' },
  'http://www.w3.org/2003/01/geo/wgs84_pos#': { file: 'wgs84.ttl', source: 'wgs84' },
  'http://purl.org/goodrelations/v1#': { file: 'gr.ttl', source: 'gr' },
  'http://usefulinc.com/ns/doap#': { file: 'doap.ttl', source: 'doap' },
  'http://purl.org/dc/dcmitype/': { file: 'dctype.ttl', source: 'dctype' },
  'http://www.w3.org/ns/locn#': { file: 'locn.ttl', source: 'locn' },
  'http://www.w3.org/ns/dqv#': { file: 'dqv.ttl', source: 'dqv' },
  'http://purl.org/pav/': { file: 'pav.ttl', source: 'pav' },
  'http://www.w3.org/ns/csvw#': { file: 'csvw.ttl', source: 'csvw' },
};
