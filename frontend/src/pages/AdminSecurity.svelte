        ...
        <div class="form-card">
          ...
          <div class="form-grid">
            <label>
              ...
              <input bind:value={clientForm.client_id} placeholder="web-app" />
            </label>
            <label>
              <span>{$t('pages.adminSecurity.clientName')}</span>
              <input bind:value={clientForm.name} placeholder="Web App" />
            </label>
          </div>
          <label>
            <span>{$t('pages.adminSecurity.clientRedirects')}</span>
            <textarea rows="2" bind:value={clientForm.redirect_uris}
              placeholder="http://localhost:5175/auth/callback"></textarea>
          </label>
